  ...
  return (
    <div style={{ backgroundColor: C.bg, color: C.text, fontFamily: 'Inter, sans-serif', overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '840px', position: 'relative', animation: 'slideUp 0.9s ease' }}>
          <Badge>✨ &nbsp; The Future of Café Experience</Badge>

          <h1 style={{ fontSize: 'clamp(2.8rem, 6vw, 5rem)', fontWeight: '800', lineHeight: '1.08', marginBottom: '1.5rem' }}>
            <span style={{
          ...
          <p style={{ fontSize: 'clamp(1rem, 2vw, 1.2rem)', color: C.muted, lineHeight: '1.85', maxWidth: '580px', margin: '0 auto 2.5rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1.25rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            {[['50+','Partner Cafés'],['10K+','Happy Customers'],['4.9★','Average Rating'],['99%','Satisfaction Rate']].map(([v, l], i) => (
              <div key={i} style={{
                ...
                borderRadius: '1rem', padding: '1.25rem 1.75rem', textAlign: 'center', minWidth: '120px'
              }}>
                <div style={{ fontSize: '1.9rem', fontWeight: '800', color: C.gold }}>{v}</div>
      ...
      {/* How It Works */}
      <section id="how" style={{ padding: '7rem 2rem', background: 'rgba(0,0,0,0.25)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
      ...
      {/* Sample Menu */}
      <section id="menu" style={{ padding: '7rem 2rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: '1rem' }}>
            {menuItems.map((m, i) => (
              <div key={i} className="menu-row" style={{
                ...
                <div style={{ color: C.gold, fontWeight: '700', fontSize: '1rem' }}>{m.price}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Testimonials */}
      <section id="reviews" style={{ padding: '7rem 2rem', background: 'rgba(0,0,0,0.25)', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            {testimonials.map((t, i) => (
              <div key={i} className="review-card" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{ width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(200,95,32,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.2rem' }}>{t.avatar}</div>
                  <div>
      ...
      <section style={{ padding: '8rem 2rem', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <h2 style={{ fontSize: 'clamp(2.2rem,5vw,4rem)', fontWeight: '800', marginBottom: '1.5rem',
          ...
          <p style={{ color: C.muted, fontSize: '1.1rem', maxWidth: '450px', margin: '0 auto 2.5rem', lineHeight: '1.8' }}>
  ...
  <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 2rem' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '2rem', marginBottom: '2rem' }}>
      ...
      <div>
        ...
        {[
          ['🔒 Privacy Policy', 'We respect your data. All personal information is encrypted and never sold to third parties.'],
          ['📋 Terms of Service', 'By using SipSpot you agree to our terms. We reserve the right to update policies.'],
          ['🍪 Cookie Policy', 'We use cookies to enhance your experience. You can manage them in your browser settings.'],
          ['♿ Accessibility', 'SipSpot is committed to making our platform accessible to everyone.'],
        ].map(([label], i) => (
          <a key={i} href="#" style={{
            display: 'block', color: C.muted, textDecoration: 'none',
            fontSize: '0.875rem', marginBottom: '0.75rem', transition: 'color 0.2s'
    ...
    {/* Bottom row */}
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', paddingBottom: '1.25rem' }}>
